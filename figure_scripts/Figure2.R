...
COLO829BL_truthset <- read_vcfs_as_granges(vcf_files = "./data/others/COLO829BLT50_truth_set/COLO829BL_somatic_07022025_filtered_PASS_snv_af_gt_25_dp_gt_100.vcf.gz",
                                          sample_names = "B-cell", ref_genome)
