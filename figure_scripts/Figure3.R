...
ggplot(simulation_results_EN_Oligo, aes(x = Age, y = burden_corrected, color = cell_type)) +
  geom_point(size = 0.2) +
  geom_errorbar(aes(ymax = burden_corrected + burden_sd, ymin = burden_corrected - burden_sd), size = 0.2, width = 4) +
...
ggsave("./figures/manuscript_figures/Figure3/OL_EN_burden_adjusted_enrichment.pdf", width = 6, height = 5.5, units = "cm")
...
ggsave("./figures/manuscript_figures/Figure3/OL_EN_enrichment.pdf", width = 6, height = 4.5, units = "cm")
...
ggplot(neuron_simulation_results, aes(x = Age, y = rate, color = cell_type_figure)) +
  ...
  annotate(geom="text", x=20, y=4e-7, parse = T, 
           ...
           color = "black", family = font, size = 2) +
  theme_classic() +  
  geom_errorbar(aes(ymax = rate + rate_sd, ymin = rate - rate_sd), size = 0.2, width = 4) +
  guides(color=guide_legend(nrow=2), override.aes = list(size=1)) +
  theme(
    text = element_text(color = "black", size = font_size, family = font),
    axis.text = element_text(color = "black", size = axis_font_size, family = font),
...
ggsave("./figures/manuscript_figures/Figure3/IN_EN_burden_raw.pdf", width = 6, height = 5.5, units = "cm")
...
ggplot(OL_OPC_simulation_results, aes(x = Age, y = rate, color = cell_type)) +
  ...
  labs(x = "Age (yrs)", y = "Mutational Burden (sSNVs/bp)")
ggsave("./figures/manuscript_figures/Figure3/OL_OPC_burden_raw.pdf", width = 6, height = 5.5, units = "cm")
...
ggplot(Astro_Micro_simulation_results, aes(x = Age, y = rate, color = cell_type)) +
  ...
  labs(x = "Age (yrs)", y = "Mutational Burden (sSNVs/bp)")
ggsave("./figures/manuscript_figures/Figure3/Astro_Micro_burden_raw.pdf", width = 6, height = 5.5, units = "cm")
...
ggsave("./figures/manuscript_figures/Figure3/EN_subtype_burden_raw.pdf", width = 6, height = 5.5, units = "cm")
