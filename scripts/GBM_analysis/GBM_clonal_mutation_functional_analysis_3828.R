...
multiomes_integrated <- readRDS("/lab-share/Gene-Lee-e2/Public/home/shulin/Duplex_multiome/data/RNA_ATAC/multiomes_integrated_20260101_GBM_3838_annotated.rds")
...
saveRDS(percentile_gene_summary, "./results/functional_analysis/GBM_3828_tumor_01012026.rds")
percentile_gene_summary <- readRDS("./results/functional_analysis/GBM_3828_tumor_01012026.rds")
