...
all_covered_cell <- readRDS("./results/clonal_mutation/clonal_mutation_site_covered_cell_GBM_3828_01012026.rds")
...
clonal_mutation_list <- 
  read.csv("./results/clonal_mutation/clonal_mutation_list_realigned_GBM_3828_20260101.csv")
...
tumor <- readRDS("./data/RNA_ATAC/multiomes_integrated_20260101_GBM_3838_annotated_tumor_only.rds")
...
for (mutation in clonal_mutations){
  ...
  ggsave(paste0("./figures/GBM_clonal_variants/all_cell_types_3828/", mutation, ".pdf"), height = 3.6, width = 2.3, units = "in")
  ...
  ggsave(paste0("./figures/GBM_clonal_variants/tumor_only_3828/", mutation, ".pdf"), height = 3.6, width = 2.3, units = "in")
}
