...
for(case_id in case_id_list){
  ...
  clonal_mutation <- read.csv("./results/clonal_mutation/clonal_mutation_list_COLO829BLT50_tumor_bulk_20240604.csv")
  ...
  saveRDS(cell_cover_clonal_mutation_site, paste0("./results/clonal_mutation/clonal_mutation_VAF_tumor_bulk_", case_id, ".rds"))
}
