...
clonal_mutation_list <- 
  read.csv("./results/clonal_mutation/clonal_mutation_list_COLO829BLT50_BLT50_bulk_realigned_20241007.csv")
#clonal_mutation_list <- read.csv("results/clonal_mutation/clonal_mutation_list_COLO829BLT50_BL_bulk_20240604.csv")
#clonal_mutation_list <- clonal_mutation_list[clonal_mutation_list$case_id == "COLO829BLT50_rep2",]
...
pdf("./figures/lineage_tracing/graph/cell_type_BLT50_bulk_20241007.pdf", width = 10, height = 10)
plot(g, layout=layout)
dev.off()

V(g)$color <- as.character(factor(case, levels = c("COLO829BLT50_rep1", "COLO829BLT50_rep2"), labels = c("blue", "white")))
pdf("./figures/lineage_tracing/graph/rep_BLT50_bulk_20241007.pdf", width = 10, height = 10)
plot(g, layout=layout)
dev.off()
...
pdf("./figures/lineage_tracing/graph/label_prop_clustering_BLT50_bulk_20241007.pdf", width = 10, height = 10)
...
saveRDS(df_label_prop_cluster_count[,c("cell", "case_id", "label_prop_cluster")], 
          "./results/lineage_tracing/label_prop_cluster_BLT50_bulk_20241007.rds")
...
ggsave("./figures/lineage_tracing/label_prop_cluster_BLT50_bulk_202410017.pdf", width = 12, height = 4)
...
pheatmap(t(clonal_mutation_matrix), scale = "none", show_colnames = F,
         ...
         cellwidth = 1, 
         cellheight = 10,
         filename = "figures/lineage_tracing/heatmap_label_prop_cluster_BLT50_bulk_20241007.pdf", height = 15)
...
# clonal_mutation_list_tumor_bulk_cell_selected_count <- clonal_mutation_list_tumor_bulk_cell_selected %>% group_by(key) %>% summarise("count" = n())
# selected_clonal_mutation <- clonal_mutation_list_tumor_bulk_cell_selected_count[clonal_mutation_list_tumor_bulk_cell_selected_count$count > 5, "key", drop = T]
# #selected_clonal_mutation <- clonal_mutation_count[clonal_mutation_count$count > 3, "key", drop = T]
# clonal_mutation_list <- clonal_mutation_list[clonal_mutation_list$key %in% selected_clonal_mutation,]
# 
# clonal_mutation_list_tumor_bulk_cell_selected <- clonal_mutation_list_tumor_bulk_cell_selected[clonal_mutation_list_tumor_bulk_cell_selected$key %in% selected_clonal_mutation, ]
# 
...
pheatmap(t(clonal_mutation_matrix+cell_cover_clonal_mutation_site), scale = "none", show_colnames = F,
         ...
         cellwidth = 1, 
         cellheight = 10, 
         filename = "figures/lineage_tracing/heatmap_label_prop_cluster_BLT50_bulk_coverage_20241007.pdf", height = 8)

save.image("./results/lineage_tracing/BLT50_bulk_20241007.RData")
