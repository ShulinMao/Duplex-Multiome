...
folder_names <- c(
  "Novogene_08052024/Mult_AN06365_corrected/outs",
  "Novogene_08052024/Mult_ABNCR6D_corrected/outs"
)
sample_names <- c("AN06365", "ABNCR6D")
...
for (i in 1:length(folder_names)) {
  ...
  png(paste("figures/ATAC/QC/Vlnplot_", sample_name, "_prefiltering_20240813_ASD_QC.png", sep = ""), res = 300, height = 1400, width = 3000)
  print(v1)
  dev.off()
  ...
  # QC filtering scATAC
  multiomes$cell_id <- colnames(multiomes)
  multiomes <- subset(
    x = multiomes,
  ...
  png(paste("figures/ATAC/QC/Vlnplot_", sample_name, "_afterfiltering_20240813_ASD_QC.png", sep = ""), res = 300, height = 1400, width = 3000)
  print(v2)
  dev.off()
...
png("figures/ATAC/UMAP/umap_scATAC_harmonyintegrated_20240813_ASD_QC.png", res = 300, height = 1600, width = 1600)
...
png("figures/RNAseq/UMAP/umap_scRNASeq_harmonyintegrated_20240813_ASD_QC.png", res = 300, height = 1600, width = 1600)
p + ggtitle("Harmony Integrated")
dev.off()
...
png(paste("figures/RNAseq/UMAP/Umap_WNNIntegrated_original_groupbysamples_20240813_ASD_QC.png", sep = ""), res = 300, height = 1600, width = 4800)
p1 + p2 + p3 & NoLegend() & theme(plot.title = element_text(hjust = 0.5))
dev.off()

########## 9. Find cluster markers ##########
markers <- FindAllMarkers(multiomes_integrated, only.pos = TRUE, min.pct = 0.25, thresh.use = 0.25)
write.csv(markers, "./results/celltype_annotation/markers_20240813_ASD.csv")

png("figures/RNAseq/Umap_Integrated_original_groupbyclusters_20240813_ASD.png", res = 300, height = 2000, width = 2200)
...
png("figures/WSNN/Umap_WNNIntegrated_original_groupbydataset_20240813_ASD.png", res = 300, height = 2200, width = 6000)
...
png("figures/WSNN/Umap_WNNIntegrated_original_groupbycluster_20240813_ASD.png", res = 300, height = 2500, width = 6000)
ggpubr::ggarrange(p1, p2, p3, nrow = 1, common.legend = T, legend = "bottom")
dev.off()

saveRDS(multiomes_integrated, "./data/RNA_ATAC/multiomes_integrated_20240813_ASD_no_annotation.rds")
