...
folder_names <- c(
  "Novogene_04292024/BLT50_A/outs", 
  "Novogene_04292024/BLT50_B/outs" 
)
sample_names <- c("COLO829BLT50_rep1", "COLO829BLT50_rep2")
...
combined.peaks <- reduce(x = c(
  gr_list$COLO829BLT50_rep1,
  gr_list$COLO829BLT50_rep2
))
...
for (i in 1:length(folder_names)) {
  ...
  png(paste("figures/ATAC/QC/Vlnplot_", sample_name, "_prefiltering_20240523_COLO829BLT50_QC.png", sep = ""), res = 300, height = 1400, width = 3000)
  print(v1)
  dev.off()
  ...
  png(paste("figures/ATAC/QC/Vlnplot_", sample_name, "_afterfiltering_20240523_COLO829BLT50_QC.png", sep = ""), res = 300, height = 1400, width = 3000)
  print(v2)
  dev.off()
...
png("figures/ATAC/UMAP/umap_scATAC_harmonyintegrated_20240523_COLO829BLT50_QC.png", res = 300, height = 1600, width = 1600)
...
png("figures/RNAseq/UMAP/umap_scRNASeq_harmonyintegrated_20240523_COLO829BLT50_QC.png", res = 300, height = 1600, width = 1600)
p + ggtitle("Harmony Integrated")
dev.off()
...
multiomes_integrated <- FindClusters(multiomes_integrated, graph.name = "wsnn", algorithm = 3, verbose = FALSE, res = 0.5)
...
png(paste("figures/RNAseq/UMAP/Umap_WNNIntegrated_original_groupbysamples_20240523_COLO829BLT50_QC.png", sep = ""), res = 300, height = 1600, width = 4800)
...
write.csv(markers, "./results/celltype_annotation/markers_20240523_COLO829BLT50.csv")

png("figures/RNAseq/Umap_Integrated_original_groupbyclusters_20240523_COLO829BLT50.png", res = 300, height = 2000, width = 2200)
DimPlot(multiomes_integrated, reduction = "umap.rna", group.by = "wsnn_res.0.8", label = TRUE, label.size = 3.5, repel = TRUE) + ggtitle("RNA")
dev.off()
png("figures/RNAseq/Umap_Integrated_original_groupbysamples_20240523_COLO829BLT50.png", res = 300, height = 2000, width = 2200)
DimPlot(multiomes_integrated, reduction = "umap.rna", group.by = "dataset") + ggtitle("RNA")
dev.off()
png("figures/WSNN/Umap_WNNIntegrated_original_groupbyclusters_20240523_COLO829BLT50.png", res = 300, height = 2000, width = 2200)
DimPlot(multiomes_integrated, reduction = "wnn.umap", group.by = "wsnn_res.0.8", label = TRUE, label.size = 3.5, repel = TRUE) + ggtitle("WNN")
dev.off()

########## 10. Cell type annotation ##########
table(multiomes_integrated$wsnn_res.0.8)
FeaturePlot(multiomes_integrated, reduction = "umap.rna", features = "S100B")
ggsave("figures/RNAseq/Umap_COLO829BLT50_S100B_expression.pdf", width = 5, height = 5)

multiomes_integrated[["celltype"]] <- ifelse(multiomes_integrated$wsnn_res.0.8==10, "melanoma_fibroblast", "B_lymphoblast")
...
png("figures/WSNN/Umap_WNNIntegrated_original_groupbycelltype_20240523_COLO829BLT50.png", res = 300, height = 2200, width = 6000)
ggpubr::ggarrange(p1, p2, p3, nrow = 1, common.legend = T, legend = "bottom")
dev.off()

saveRDS(multiomes_integrated, "./data/RNA_ATAC/multiomes_integrated_20240523_COLO829BLT50.rds")

write.table(multiomes_integrated[[c("dataset", "cell.id", "celltype")]], 
            "./results/celltype_annotation/annotation_COLO829BLT50_20240523.txt", sep = "\t",
